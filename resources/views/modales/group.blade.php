<div class="modal fade" id="group_details" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
            ...
            <form action="#" id="form-enviar" method="post">
                ...
                <div class="modal-body">
                    <input type="hidden" id="id" name="id" value=""
                        class="modal_registro_group_id" />
                    <div class="row">
                        <div class="col-12 mb-3">
                            <div class="input-block mb-0">
                                <label>@lang('Name') <span class="text-danger">*</span></label>
                                <input type="text" name="name" id="name" class="form-control"
                                    placeholder="@lang('Enter Group Name')">
                            </div>
                        </div>
                        <div class="col-12 mb-3">
