            ...
            <div class="content-page-header">
                ...
                <div class="list-btn">
                    <ul class="filter-list">
                        ...
                        @can('representatives.store')
                            <li>
                                <a class="btn btn-primary" href="#" data-bs-toggle="modal"
                                    data-bs-action="{{ route('representatives.store') }}"
                                    data-bs-target="#add_representative"><i class="fa fa-plus-circle me-2"
                                        aria-hidden="true"></i>@lang('Add Representative')</a>
                            </li>
                        @endcan
                    </ul>
                </div>
                                                            ...
                                                            @can('representatives.edit')
                                                                <li>
                                                                    <a href="#" type="button" data-bs-toggle="modal"
                                                                        data-bs-target="#add_representative"
                                                                        class="btn btn-greys me-2"
                                                                        data-bs-record-id="{{ $item->id }}"
                                                                        data-bs-action="{{ route('representatives.update', $item) }}">
                                                            ...
                                                            @can('representatives.destroy')
                                                                <li>
                                                                    <a class="btn btn-greys me-2" data-bs-toggle="modal"
                                                                        ...
                                                                        data-bs-record-id="{{ $item->id }}"
                                                                        data-bs-record-title="{{ 'El Representante ' }}{{ $item->user->name }}&nbsp;{{ $item->user->last_name }}"
                                                                        data-bs-action="{{ route('representatives.destroy', $item) }}"
                                                                        title="{{ __('Delete Representative') }}"><i
...
@endsection
@section('modal')
    @include('modales.representative')
