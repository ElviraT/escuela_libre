                        ...
                        @can('teachers.store')
                            <li>
                                <a class="btn btn-primary" href="#" data-bs-toggle="modal"
                                    data-bs-action="{{ route('teachers.store') }}" data-bs-target="#add_teacher"><i
                                        class="fa fa-plus-circle me-2" aria-hidden="true"></i>@lang('Add Teacher')</a>
                            </li>
                        @endcan
                    </ul>
                </div>
                                                            ...
                                                            @can('teachers.edit')
                                                                <li>
                                                                    <a href="#" type="button" data-bs-toggle="modal"
                                                                        data-bs-target="#add_teacher" class="btn btn-greys me-2"
                                                                        data-bs-record-id="{{ $item->id }}"
                                                                        data-bs-action="{{ route('teachers.update', $item) }}">
                                                            ...
                                                            @can('teachers.destroy')
                                                                <li>
                                                                    <a class="dropdown-item" data-bs-toggle="modal"
                                                                        ...
                                                                        data-bs-record-id="{{ $item->id }}"
                                                                        data-bs-record-title="{{ 'El Profesor ' }}{{ $item->name }}"
                                                                        data-bs-action="{{ route('teachers.destroy', $item) }}"
                                                                        title="{{ __('Delete Teacher') }}"><i
