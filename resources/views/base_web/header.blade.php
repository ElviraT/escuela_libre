                ...
                <div class="col-3">
                    <a href="#" class="navbar-brand font-weight-bold text-secondary">
                        <img src="{{ asset(isset($setting) ? Storage::url('logos/' . Session::get('logo')) : '') }}"
                            alt="Logo" width="80" class="logo img-fluid">
                    </a>
                </div>
                <div class="col-9">
                    ...
                    <div class="collapse navbar-collapse justify-content-rigth" id="navbarCollapse">
                        <div class="navbar-nav font-weight-bold mx-auto py-0">
                            <a class="nav-item nav-link {{ @request()->routeIs('home') ? 'active' : ' ' }}"
                                href="{{ route('home') }}">Home</a>
                            <a class="nav-item nav-link {{ @request()->routeIs('project') ? 'active' : ' ' }}"
                                href="{{ route('project') }}">Proyecto Educativo</a>
    ...
    <div class="container-fluid bg-secondary text-white mt-5 py-5 px-sm-3 px-md-5">
        <div class="row pt-5">
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <div class="d-flex justify-content-start mt-4">
                    ...
                    <a class="btn btn-outline-primary rounded-circle text-center mr-2 px-0"
                        style="width: 38px; height: 38px;" href="{{ isset($setting) ? $setting->instagram : '#' }}"><i
                            class="fab fa-instagram"></i></a>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 mt-5 mb-5">
                <h3 class="text-primary mb-4">@lang('Get In Touch')</h3>
                <div class="d-flex">
        ...
        <div class="container-fluid pt-5" style="border-top: 1px solid rgba(23, 162, 184, .2);;">
            <p class="m-0 text-center text-white">
                &copy; <a class="text-primary font-weight-bold"
                    href="#">{{ isset($setting) ? $setting->name : env('APP_NAME') }}</a>. @lang('All Rights Reserved').
                @lang('Designed by')
                <a class="text-primary font-weight-bold" href="#"><i
                        class="far fa-gem"></i>&nbsp;Gema-Technology</a>
            </p>
        </div>
    </div>
    <!-- Footer End -->
