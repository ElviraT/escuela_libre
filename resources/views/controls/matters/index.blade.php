                        ...
                        @can('matters.store')
                            <div class="list-btn">
                                <a class="btn btn-primary" href="#" data-bs-toggle="modal"
                                    data-bs-action="{{ route('matters.store') }}" data-bs-target="#matter_details"><i
                                        class="fa fa-plus-circle me-2" aria-hidden="true"></i>@lang('Add Matter')</a>
                                                                        ...
                                                                        @can('matters.edit')
                                                                            <li>
                                                                                <a href="#" type="button"
                                                                                    ...
                                                                                    data-bs-target="#matter_details"
                                                                                    class="btn btn-greys me-2"
                                                                                    data-bs-record-id="{{ $item->id }}"
                                                                                    data-bs-action="{{ route('matters.update', $item) }}">
                                                                        ...
                                                                        @can('matters.destroy')
                                                                            <li>
                                                                                <a class="btn btn-greys me-2"
                                                                                    ...
                                                                                    data-bs-record-id="{{ $item->id }}"
                                                                                    data-bs-record-title="{{ 'la materia ' }}{{ $item->name }}"
                                                                                    data-bs-action="{{ route('matters.destroy', $item) }}"
                                                                                    title="{{ __('Delete Matters') }}"><i
