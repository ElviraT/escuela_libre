            ...
            <div class="card">
                <div class="card-body w-100">
                    <div class="content-page-header p-0">
                        <h5>@lang('Modalities')</h5>
                        @can('modalities.store')
                            <div class="list-btn">
                                <a class="btn btn-primary" href="#" data-bs-toggle="modal"
                                    data-bs-action="{{ route('modalities.store') }}" data-bs-target="#modality_details"><i
                                        class="fa fa-plus-circle me-2" aria-hidden="true"></i>@lang('Add Modality')</a>
                                                                        ...
                                                                        @can('modalities.edit')
                                                                            <li>
                                                                                <a href="#" type="button"
                                                                                    ...
                                                                                    data-bs-target="#modality_details"
                                                                                    class="btn btn-greys me-2"
                                                                                    data-bs-record-id="{{ $item->id }}"
                                                                                    data-bs-action="{{ route('modalities.update', $item) }}">
                                                                        ...
                                                                        @can('modalities.destroy')
                                                                            <li>
                                                                                <a class="btn btn-greys me-2"
                                                                                    ...
                                                                                    data-bs-action="{{ route('modalities.destroy', $item) }}"
                                                                                    title="{{ __('Delete Modalitys') }}"><i
