...
@section('content')
    ...
    <div class="messenger">
        ...
        <div class="messenger-listView {{ !!$id ? 'conversation-active' : '' }}">
            ...
            <div class="m-header">
                <nav>
                    <a href="#"><i class="fas fa-inbox"></i> <span class="messenger-headTitle">@lang('MESSAGES')</span>
                    </a>
                    {{-- header buttons --}}
            ...
            <div class="m-body contacts-container">
                ...
                <div class="show messenger-tab users-tab app-scroll" data-view="users">
                    ...
                    <div class="favorites-section">
                        <p class="messenger-title"><span>@lang('Favorites')</span></p>
                        <div class="messenger-favorites app-scroll-hidden"></div>
                    </div>
                    {{-- Saved Messages --}}
                    <p class="messenger-title"><span>@lang('Your Space')</span></p>
                    {!! view('Chatify::layouts.listItem', ['get' => 'saved']) !!}
                    {{-- Contact --}}
                    <p class="messenger-title"><span>@lang('All Messages')</span></p>
                    <div class="listOfContacts" style="width: 100%;height: calc(100% - 272px);position: relative;"></div>
                </div>
                {{-- ---------------- [ Search Tab ] ---------------- --}}
                <div class="messenger-tab search-tab app-scroll" data-view="search">
                    {{-- items --}}
                    <p class="messenger-title"><span>@lang('Search')</span></p>
